...
import day1 from './ETH/Prediction_1days.png';
import day3 from './ETH/Prediction_3days.png';
import day5 from './ETH/Prediction_5days.png';
...
export const EthereumPage = () => {
  ...
  useEffect(() => {
    fetch('results/ETH/Prediction_1days.txt')
      .then((response) => {
        if (response.ok) {
  ...
  useEffect(() => {
    fetch('results/ETH/Prediction_3days.txt')
      .then((response) => {
        if (response.ok) {
          return response.text();
        } else {
  ...
  useEffect(() => {
    fetch('results/ETH/Prediction_5days.txt')
      .then((response) => {
        if (response.ok) {
          return response.text();
        } else {
